...
/* harmony import */ var _module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./module */ "./src/es/module.js");
...
console.log(Object(_module__WEBPACK_IMPORTED_MODULE_0__["greet"])('Hello'));
...
function draw() {
  ...
  ctx.clearRect(0, 0, canvasWidth, canvasHeight); //Background
...
var greet = function greet(say) {
  return "".concat(say, " from module!");
};
